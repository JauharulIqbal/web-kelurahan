<nav id="navbarMain" class="navbar navbar-expand-lg fixed-top navbar-dark bg-transparent transition">
    <div class="container py-1">
        ...
        <img class="navbar-brand object-fit" src="/images/Logo-Surabaya.png" alt="Logo Surabaya" width="60" height="80">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ url('/galeri') }}">BERITA</a></li>
